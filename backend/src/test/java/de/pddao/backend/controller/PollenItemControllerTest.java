    ...
    void listAllPollenItemsTest() {
        ...
        assertThat(response.getBody(), arrayContainingInAnyOrder(
                ...
                PollenItem.builder()
                        ...
                        .beginBloomingSeason("March")
                        .endBloomingSeason("May")
