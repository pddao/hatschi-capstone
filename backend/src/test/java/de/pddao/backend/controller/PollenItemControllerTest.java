...
//                        .description("Die Ambrosia gehört zu lorem ipsum").build(),
//
//                PollenItem.builder()
...
//                        .description("Die Erle gehört zu lorem ipsum").build(),
//
//                PollenItem.builder()
...
//                        .endBloomingSeason(BloomingMonth.APRIL)
//                        .description("In Mitteleuropa häufig vorkommender Strauch vom Norddeutschen Tiefland bis zu 1400 m Höhe in den Alpen, in Laubwäldern, an Waldrändern oder als Hecken.").build(),
//
//                PollenItem.builder()
...
//                        .endBloomingSeason(BloomingMonth.SEPTEMBER)
//                        .description("Der Beifuß gehört zu lorem ipsum").build(),
//
//                PollenItem.builder()
...
//                        .description("Die Gräser gehören zu lorem ipsum").build(),
//
//                PollenItem.builder()
...
//                        .description("The rye lorem upsum").build(),
//
//                PollenItem.builder()
...
//                        .description("Weit verbreiteter Laubbaum, auch gerne als Park- und Alleebaum in Städten verwendet").build(),
//
//                PollenItem.builder()
...
//                        .beginBloomingSeason(BloomingMonth.MARCH)
//                        .endBloomingSeason(BloomingMonth.MAY)
//                        .description("In Mitteleuropa weit verbreitet, vom Flachland bis zu 1400 m Höhe in den Alpen, bevorzugt feuchte Standorte").build()
//        ));
//    }
//}